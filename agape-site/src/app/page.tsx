...
const RESIDENTS = [
  ...
  },
  {
    ...
    bio: "Johannes Schuster is a potent force in the world of electronic music. Resident for iconic German event brands Unreal and 303, he has been playing and collecting vinyl since he was 15, building a global reputation through his incendiary DJ sets. A heady blend of dark, industrial tunes, bright and emotional pads, ravey acid and old school grooves form the nucleus of Johannes' mesmerising sound.\n\nHe has released solo productions and remixes on a range of prominent labels — including Green Fetish, Soma, NineTimesNine, Voxnox, RND Records, Märked and many more — with a packed global tour schedule.\n\nHis first residency, in 2017, was with legendary Cologne spot Artheater. At Artheater Johannes became resident for the acid techno party 303. Playing regularly at such a renowned spot gave him the chance to carve out his own pathway within the local scene, performing alongside a long list of techno heavyweights. In 2021 Johannes joined the family at Unreal, one of Germany's premier hard techno outfits, held at infamous Cologne club Bootshaus.\n\nJohannes has since become a highly-regarded hard techno artist, travelling the global circuit and igniting dance floors everywhere he plays. His unique DJ sets blend love and hate, taking the dance floor to an unforgettable climax through unexpected twists and turns, peaks and troughs, old and new, darkness and light, to give them a truly human emotional, and physical, experience.",
  },
  {
    name: "Junkfile",
    role: "Founder / DJ",
